...
const UpcomingSongForHome = () => {
  ...
  return (
    <div className="w-full py-16 px-4 relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-black via-black to-black animate-gradient-shift"></div>
      
      {/* Light Effects */}
      <div className="absolute inset-0">
        {/* Random Independent Lights */}
        <div className="absolute w-96 h-96 bg-red-600 rounded-full mix-blend-screen opacity-10 blur-3xl animate-random-light-1"></div>
        <div className="absolute w-96 h-96 bg-red-600 rounded-full mix-blend-screen opacity-10 blur-3xl animate-random-light-2"></div>
        <div className="absolute w-96 h-96 bg-red-600 rounded-full mix-blend-screen opacity-10 blur-3xl animate-random-light-3"></div>
        <div className="absolute w-96 h-96 bg-red-600 rounded-full mix-blend-screen opacity-10 blur-3xl animate-random-light-4"></div>
      </div>
...
export default UpcomingSongForHome; 